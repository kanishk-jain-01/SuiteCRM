/**
 * SuiteCRM Chat Assistant - Easy Embed Snippet
 * 
 * Add this script to your SuiteCRM pages to include the chat assistant.
 * Usage: Just include this script tag in your HTML:
 * <script src="path/to/embed_snippet.js"></script>
 */
...
(function() {
    ...
    const CHAT_CONFIG = {
        ...
        theme: 'suitecrm', // Theme: suitecrm, dark, light
    ...
    const styles = `
        ...
        .chat-fab:hover {
            transform: scale(1.1);
            box-shadow: 0 6px 20px rgba(31, 78, 121, 0.6);
        }
